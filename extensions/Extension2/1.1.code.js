(async function(Scratch) {
    ...
    class Extension {
        getInfo() {
            return {
                ...
                "blocks": [{
                    ...
                    "opcode": "block_f349b1e1faf7406d",
                    "text": "Версия расширения",
                    "blockType": "reporter",
                    "arguments": {}
                }, {
                    "opcode": "block_669265e160b1ac28",
                    "text": "[fe8741ceaeb52d64] + [27d6380547ca1d78] + [fb0aa393c03cd153] {}+({}+{})",
                    "blockType": "reporter",
                    "arguments": {
                        "fe8741ceaeb52d64": {
                            "type": "number",
                    ...
                    "opcode": "block_b90bf08f71c93af8",
                    "text": "[a47346f5d732abe7] ^ [9f0f4ca893c25bfc]",
                    "blockType": "reporter",
                    "arguments": {
                        "a47346f5d732abe7": {
                            "type": "number",
                    ...
                    "opcode": "block_9a9935e9042edffe",
                    "text": "конвертировать [e311b85974ee32ac] в число",
                    "blockType": "Boolean",
                    "arguments": {
                        "e311b85974ee32ac": {
                            "type": "Boolean"
        ...
        async block_bae564ff9ebd4e16(args) {
            return (vm.runtime.ext_scratch3_operators._random((1), (100)))
        }
        ...
        async block_28353adbc01a59b1(args) {
            if ((args["546a74f03f79ad80"] <= args["b2a0faf3591cfb17"])) {
                return (true)
            } else {
                return (false)
            };
        ...
        async block_f349b1e1faf7406d(args) {
            return (("1.1"))
        }
        async block_669265e160b1ac28(args) {
            return ((args["fe8741ceaeb52d64"] + (args["27d6380547ca1d78"] + args["fb0aa393c03cd153"])))
        }
        async block_b90bf08f71c93af8(args) {
            return ((args["a47346f5d732abe7"] ** args["9f0f4ca893c25bfc"]))
        }
        async block_9a9935e9042edffe(args) {
            if (args["e311b85974ee32ac"]) {
                return (("1"))
            } else {
                return (("0"))
            };
